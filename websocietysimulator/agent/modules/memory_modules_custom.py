...
class MemoryDILU(MemoryBase):
    def __init__(self, llm, reset: bool = False):
        # Use a dedicated long-term store separate from default memory_modules
...
class MemoryGenerative(MemoryBase):
    def __init__(self, llm, reset: bool = False):
        # Long-term store for generative memory
...
class MemoryVoyager(
    ...
    def __init__(self, llm, reset: bool = False):
        # Long-term store for Voyager memory
